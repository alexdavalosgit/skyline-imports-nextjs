...
function Information() {
  return (
    <Container fluid className="p-0 mt-5 mx-auto">
      <Stack gap={5}>
        <div className="border information p-5">
              <h1 className='text-center'>What is JDM?</h1>
              <p>If you have a passion for collecting antique cars, you have probably heard of the term JDM. 
        ...
        <div className="border information p-5">
              <h1 className='text-center'>The Best in JDM Imports!</h1>
              <p>When it comes to Japanese Domestic Market imports, it’s vital that you trust the source. That’s why, at Skyline Imports, we only deal in the best of the best.
        ...
        <div className="border information p-5">
              <h1 className='text-center'>Taking the Trouble Out of Overseas Purchases!</h1>
              <p>
                  ...
                  From the initial search to the financing process, JDM Sport Classics has got you covered.

                  Check out our current stock, take a look at our incoming vehicles, and get in touch if you have any questions!

                  Our extensive inventory includes, but is certainly not limited to:</p>
                <ul>
